 ...
 */
export class AuthenticationCustomLoopbackClient implements ILoopbackClient {
  ...
  ): Promise<AuthenticationCustomLoopbackClient> {
    const loopbackClient = new AuthenticationCustomLoopbackClient();
        ...
        this.server = http.createServer(
          ...
          async (
            ...
            const authCodeResponse =
              AuthenticationCustomLoopbackClient.getDeserializedQueryString(
                url
              );
